...
public class TrustCalcController {
	...
	//////////////////////////////////*********RenteeRank********//////////////////////////////
	public double calcRenteeRank(String RenteeId,String RenterId)
	{
		System.out.println("Inside calc Rentee Rank");
		double Rank = 0.0;
	...
	//	System.out.println("Connections are: "+cons);
		...
		{
		//	System.out.println("Connection is: "+con1);
			if(con1.getUserid().equals(RenterId))
			{
				directTrust = con1.getRenteTrust();
				
				friendTrust = con1.getActiveFriend();	
			}
			else{
				double val = con1.getRenteTrust();
			//	System.out.println("Value of renter trust: "+val);
				if(val >0)
				{
					PosTrxCnt++;
